...
'>
     ...
     <div className="relative flex flex-col justify-center    mr-0    md:mx-0   ">
          ...
          <div className="w-96   xl:w-[400px]">
             <img id='Image'  src='#' className='w-96 h-96 p-2   mx-auto' alt="" />
             <div className="flex mt-auto  mt-5">
                      ...
                      className=' w-1/5 h-18 rounded-full pl-2 pr-2 pt-2  flex justify-center   cursor-pointer border-white border-2  '>
                          <img className='w-14 h-14 border rounded-xl p-2' src='#' alt="" />
                      </div>
    ...
    <div className="flex-col justify-left xl">
            ...
            <p className='text-xs text-gray-500 text-left '></p>
              ...
              <h2 className='p-2 font-bold text-blue-900 text-left text-2xl'></h2>
              <h2 className='p-2 font-medium text-blue-900 text-md text-left'> TK</h2>
